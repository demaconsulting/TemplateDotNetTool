...
`AGENT_REPORT_code_review_auth_module.md`) to document review criteria, identified issues, and
...
needs-review:
  ...
  - "!docs/**/requirements.md"  # exclude auto-generated
...
reviews:
  ...
  - id: Documentation-Set
    title: Review of technical documentation
    paths:
      - "docs/**/*.md"
      - "requirements.yaml"
```
...
# Example elaborated output for Core-Logic review set:
# Core-Logic Review Set Coverage:
# src/Core/BusinessLogic.cs
# src/Core/DataAccess.cs  
# src/Core/Configuration.yaml
```
