...
docs/
  ...
  requirements_report/
    trace-matrix.md      # Generated by ReqStream
  build_notes/
...
- **XML Documentation (C#)** and **Doxygen Comments (C++)**: Can be read and reviewed by @technical-writer agent for
...
- If code examples, API documentation, or code comments need updating, then call the @software-developer agent with
  the **request** to update code examples, API documentation, and code comments (XML/Doxygen) with **context** of
...
- **Never edit code comments directly** (XML/Doxygen comments should be updated by @software-developer agent)
